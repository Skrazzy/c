    ...
    return (
      ...
      >
        <div
          ref={ref}
          className={ny(
            "stepper__main-container bg-white h-[80px] font-poppins rounded-[8px] mt-3",
    ...
    variants: {
      variant: {
        circle: ny(
          ...
          "[&:not(:last-child)]:after:bg-transparent [&:not(:last-child)]:after:w-[2px] [&:not(:last-child)]:after:content-['']",
    ...
    return (
      <div
        ...
        className={ny(
          ...
          "[&:not(:last-child)]:after:transition-all [&:not(:last-child)]:after:duration-200",
          "[&:not(:last-child)]:after:bg-transparent [&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:content-['']",
          "data-[completed=true]:[&:not(:last-child)]:after:bg-primary",
          "data-[invalid=true]:[&:not(:last-child)]:after:bg-destructive",
          variant === "circle-alt" &&
...
function StepButtonContainer({
  ...
  return (
    <Button
      ...
      className={ny(
        "stepper__step-button-container text-main !max-w-[50px] !px-0 !max-h-[50px]",
  ...
  return shouldRender ? (
    ...
    >
      {!!label && (
        <span
          className={ny(
            "stepper__step-label text-text font-poppins_light",
            labelVariants({ size }),
            styles?.["step-label"]
          )}
        >
